...
RSpec.describe SolidusPaypalBraintree::AVSResult::AVSMapping do
  let(:described_class) { SolidusPaypalBraintree::AVSResult }

  describe 'AVS response message' do
    subject { described_class.build(transaction).to_hash['message'] }

    context 'when with avs_error_response_code' do
      let(:transaction) do
    ...
    context 'when without avs_error_response_code' do
      let(:transaction) do
        instance_double('Braintree::Transaction',
      ...
      context 'when street address result is M and postal code result is N' do
        ...
        it do
          expect(described_class.build(transaction).to_hash).to include('street_match' => 'M',
                                                                        'postal_match' => 'N')
        end
      end
      ...
      context 'when street address result is N and postal code result is N' do
        ...
        it do
          expect(described_class.build(transaction).to_hash).to include('street_match' => 'N',
                                                                        'postal_match' => 'N')
        end
      end
      ...
      context 'when street address result is I and postal code result is N' do
        ...
        it do
          expect(described_class.build(transaction).to_hash).to include('street_match' => 'I',
                                                                        'postal_match' => 'N')
        end
      end
      ...
      context 'when street address result is A and postal code result is N' do
        ...
        it do
          expect(described_class.build(transaction).to_hash).to include('street_match' => 'A',
                                                                        'postal_match' => 'N')
        end
      end
      ...
      context 'when street address result is U and postal code result is U' do
        ...
        it do
          expect(described_class.build(transaction).to_hash).to include('street_match' => 'U',
                                                                        'postal_match' => 'U')
        end
      end
      ...
      context 'when street address response code is nil' do
        ...
        it do
          expect(described_class.build(transaction).to_hash).to include('street_match' => nil,
                                                                        'postal_match' => 'M')
        end
      end
      ...
      context 'when AVS is bypassed(sandbox)' do
        let(:codes) { %w[B B] }

        it { is_expected.to eq 'Street address matches, but postal code not verified.' }

        it do
          expect(described_class.build(transaction).to_hash).to include('street_match' => 'B',
                                                                        'postal_match' => 'B')
        end
      end
    end
