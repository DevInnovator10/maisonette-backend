...
RSpec.describe Maisonette::Trends::JustIn::CategoryInteractor do
  describe '#call' do
    ...
    it 'calls update_category_trend with taxons that are tracking insights on' do
      expect(interactor).to have_received(:update_category_trend).with(taxon_name: Spree::Taxon::NEW_IN,
