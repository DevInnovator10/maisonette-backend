Spree.Views.Order.Summary = Backbone.View.extend({
  ...
  render: function () {
    ...
    this.$('.order-shipment_total').toggleClass("hidden", Number(this.model.get("adjusted_shipment_total")))
    this.$('dd.order-shipment_total').text(this.model.get("display_adjusted_shipment_total"))
